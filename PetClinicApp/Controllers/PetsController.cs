...
namespace PetClinicApp.Controllers
{
    public class PetsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var applicationDbContext = _context.Pet.Include(p => p.Owner). Include(p => p.Vaccines);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,OwnerId,VaccinesParams")] Pet pet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,OwnerId,VaccinesParams")] Pet pet)
        {
            if (id != pet.Id)
            {
                return NotFound();
